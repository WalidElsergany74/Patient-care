...
export default function AdminLayout({
  ...
  const navLinks = useMemo(
    () => [
      {
        href: `/${locale}/admin`,
        label: locale === Languages.ARABIC ? "الصفحة الرئيسية" : "Dashboard",
        icon: <LayoutDashboard size={18} />,
      },
      {
        href: `/${locale}/admin/doctors`,
        label: locale === Languages.ARABIC ? "الأطباء" : "Doctors",
        icon: <Stethoscope size={18} />,
      },
      {
        href: `/${locale}/admin/appointments`,
        label: locale === Languages.ARABIC ? "المواعيد" : "Appointments",
        icon: <Calendar size={18} />,
      },
      {
        href: `/${locale}/admin/patients`,
        label: locale === Languages.ARABIC ? "المرضي": "Patients",
        icon: <Users size={18} />,
      },
      {
        href: `/${locale}/admin/profile`,
        label: locale === Languages.ARABIC ? "الملف الشخصي": "Profile",
        icon: <User size={18} />,
      },
    ],
    [locale]
  ...
  return (
    <div className="min-h-screen flex bg-gray-100 dark:bg-gray-900">
      ...
      <main
        className={cn(
          "flex-1 p-3 pt-24 bg-gray-100 dark:bg-gray-900 min-h-screen mb-20 md:mb-0",
